...
global.roomCaptionLast = global.gameName;
window_set_caption(global.gameName);

global.md5StrAdd = "Jtool Runner";  //sets what to add to the end of md5 input string to make the save harder to mess with, can be changed to anything, should be set to something unique and hard to predict (like setting a password)
