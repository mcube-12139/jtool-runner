...
global.mapIndex = -1;
global.mapSkinInfo = pointer_null;
...
global.dotkid = false;
global.saveType = SAVE_TYPE_SHOOT;
global.borderType = BORDER_TYPE_DEATH;
...
var gameDir = working_directory + global.gameName;
var gameDataDir = gameDir + "/Data";
if (!directory_exists(gameDir)) {
    directory_create(gameDir);
}
if (!directory_exists(gameDataDir)) {
    directory_create(gameDataDir);
}
